...
const ServicesSection = () => {
  ...
  return (
    <section className="bg-[#0d0e0f] text-white border-b border-white px-4 sm:px-5 py-2 sm:py-16 md:py-5 md:pb-44 overflow-hidden side-nudge">
      <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-start max-w-7xl mx-auto">
        {/* Left: Text */}
        <div>
        ...
        <div className="flex flex-col items-center mt-10 md:mt-0 md:pl-10 lg:pl-20 xl:pl-28">
          {/* Discover */}
          <div className="w-full max-w-md flex justify-end md:mr-0 mb-8 sm:mb-10 sm:flex">
            <a
              href="/services"
              className="hidden sm:flex text-base sm:text-lg underline decoration-[1px] font-semibold decoration-white hover:decoration-gray-400 transition :-mr-6"
            >
          ...
          {/* Image */}
          <div className="relative w-full max-w-sm sm:max-w-md md:max-w-lg h-[350px] sm:h-[450px] md:h-[650px] overflow-hidden shadow-lg rounded-sm">
            {images.map((src, i) => (
              <motion.img
                key={i}
                src={src}
          ...
          <div className="w-full max-w-sm sm:max-w-xl mt-4 flex items-center justify-between px-2 sm:px-0">
            <span className="text-xs sm:text-xl text-gray-50 tracking-wide ml-2 sm:ml-8 md:ml-2">
